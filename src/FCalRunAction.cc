...
FCalRunAction::FCalRunAction() : G4UserRunAction()
{
	...
	*/
	...
	// const FCalDetectorConstruction* dc = G4RunManager::GetRunManager()->GetUserDetectorConstruction();
	// G4double rMin = dc->rodOuterRadius;
	// G4double rMax = dc->tubeInnerRadius;
	// G4double rMin = 4.712 / 2;
	// G4double rMax = 5.25 / 2;
	// G4cout << "test " << rMin << ", " << rMax << G4endl;
	/*
	analysisManager
